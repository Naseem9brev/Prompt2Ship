...
Phase 1 deployment settings, Supabase environment variable mapping, and the GitHub OAuth callback URL matrix are documented in [`../docs/deployment.md`](../docs/deployment.md).
